...
public partial class AppShell : Shell
{
	public AppShell()
	{
        ...
        Routing.RegisterRoute(nameof(ListViewPlaygroundPage), typeof(ListViewPlaygroundPage));
        Routing.RegisterRoute(nameof(ListViewShowcasePage), typeof(ListViewShowcasePage));
    }
}